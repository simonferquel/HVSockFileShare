...
namespace HVFiles {
	...
	public:
		...
		InvalidSocketException(int errorCode) : _errorCode(errorCode) {}
	};
	...
	public:
		...
		virtual const char* what() const noexcept{
			return "Read / Write operation failed";
		}
		ReadWriteOperationFailedException(int errorCode) : _errorCode(errorCode) {}
	};
